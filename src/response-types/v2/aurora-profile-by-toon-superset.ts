...
const MatchMakedStatsSchema = z.array(
  z.object({
    benefactor_id: z.string(),
    bucket: z.number(),
...
const GameResultsSchema = z.array(
  z.object({
    attributes: z.object({
...
export const AuroraProfileByToonSupersetNoResultResponseSchema = z.object({
  aurora_id: z.literal(0),
  ...
  game_results: GameResultsSchema.length(0),
  matchmaked_current_season: z.number(),
  matchmaked_current_season_buckets: z.array(z.number()),
  matchmaked_stats: MatchMakedStatsSchema.length(0),
  profiles: z.null(),
  program_id: z.string(),
  replays: ReplaysSchema.length(0),
  stats: StatsSchema.length(0),
...
export const AuroraProfileByToonSupersetResponseSchema = z.object({
  ...
  game_results: GameResultsSchema,
  matchmaked_current_season: z.number(),
  matchmaked_current_season_buckets: z.array(z.number()),
  matchmaked_stats: MatchMakedStatsSchema,
  profiles: z
    .array(
      z.object({
        avatar_id: z.string(),
